        ...
        <div class="  form-main" id="form">
            <form method="post" action="<?php echo $controlador->link_fc_key_csd_alta_bd;?>" class="form-additional" enctype="multipart/form-data">
                ...
                <div class="buttons col-md-12">
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-info btn-guarda col-md-12 " name="btn_action_next" value="subir_key">Guarda</button>
                    </div>
                    <div class="col-md-6 ">
        ...
        <div class="lista">
            <div class="card">
                <div class="card-header">
                    <span class="text-header">Registro de Keys</span>
                </div>
                <div class="card-body">
                    <div class="cont_tabla_sucursal  col-md-12">
                        <table id="fc_key_csd" class="table table-striped" ></table>
                    </div>
                </div>
            </div>
        </div>
