...
class controlador_fc_conf_traslado extends \gamboamartin\facturacion\controllers\controlador_fc_conf_traslado {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){
        ...
        $this->titulo_lista = 'Configuracion Traslado';

        $this->sidebar['lista']['titulo'] = "Configuraciones de Traslado";
