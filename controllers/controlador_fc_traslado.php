...
class controlador_fc_traslado extends \gamboamartin\facturacion\controllers\controlador_fc_traslado {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){
        ...
        $this->sidebar['lista']['titulo'] = "Traslado";
        $this->sidebar['lista']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Alta", link: $this->link_alta,menu_seccion_active: true,
                menu_lateral_active: true));

        $this->sidebar['alta']['titulo'] = "Alta Traslado";
        ...
        $this->sidebar['modifica']['titulo'] = "Modifica Traslado";
